...
class TextsControllerTest < ActionController::TestCase
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post :create, text: { first_name: @text.first_name, last_name: @text.last_name, phone_number: @text.phone_number }
    end
  ...
  test "should update text" do
    put :update, id: @text, text: { first_name: @text.first_name, last_name: @text.last_name, phone_number: @text.phone_number }
    assert_redirected_to text_path(assigns(:text))
  end
